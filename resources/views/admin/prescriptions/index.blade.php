                    ...
                    <tr class="hover:bg-slate-50/40 transition-colors">
                        ...
                        <td class="px-6 py-5">
                            <div class="relative w-20 h-20 rounded-2xl border border-slate-200 overflow-hidden bg-slate-100 group cursor-zoom-in" 
                                 onclick="openAdminLightbox('{{ asset('storage/' . $prescription->image_path) }}', '{{ $prescription->user->name }}')">
                                <img src="{{ asset('storage/' . $prescription->image_path) }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-200">
