...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-slate-900 antialiased bg-slate-50 selection:bg-teal-600 selection:text-white relative overflow-x-hidden">
        ...
        <div class="min-h-screen flex flex-col justify-center items-center px-4 py-8 sm:p-6">
            ...
            <div class="w-full max-w-md px-5 py-7 sm:px-8 sm:py-10 bg-white/80 backdrop-blur-xl shadow-2xl shadow-slate-200/50 border border-white overflow-hidden rounded-3xl relative">
                <div class="absolute top-0 inset-x-0 h-1.5 bg-gradient-to-r from-teal-400 to-teal-600"></div>
                
                {{ $slot }}
            </div>
            
            <div class="mt-6 sm:mt-10 text-center text-sm font-medium text-slate-400">
